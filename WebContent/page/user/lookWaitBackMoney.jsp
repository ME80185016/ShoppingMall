                            ...
                            <div class="col-xs-12">
                                    <div class="cart-table table-responsive">
                                        <table>
                                            ...
                                            <tbody class="pt-30">
                                               <c:forEach items="${requestScope.waitBackMoneys}" var="waitBackMoney">
                                                <tr>
                                                    <td class="p-name">
                                                        ${waitBackMoney.store_name}
                                                    </td>
                                                    <td class="p-amount"><span class="amount">${waitBackMoney.order_time }</span></td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    		<c:when test="${waitBackMoney.order_state=='4'}">
                                                    			待退款
                                                    		</c:when>
                                                    	</c:choose>
                                                    </span>
                                                    </td>
                                                    <td class="p-total">${waitBackMoney.order_money} <a href="/ShoppingMall/user/deleteOrderById.do?order_id=${waitBackMoney.order_id}"><i class="fa fa-trash"></i></a></td>
                                                    <td>
                                                    	<form action="/ShoppingMall/user/lookOrderLine.do" method="post">
                                                    		<input name="order_id" value="${waitBackMoney.order_id}" hidden="hidden">
