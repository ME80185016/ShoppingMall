                                    ...
                                    <div class="cart-table table-responsive">
                                        <table>
                                            <thead>
                                               ...
                                               <c:forEach items="${requestScope.shoppingOrders}" var="shoppingOrder">
                                                <tr>
                                                    <td class="p-name">
                                                        ${shoppingOrder.store_name}
                                                    </td>
                                                    <td class="p-amount">
                                                    	<span class="amount">${shoppingOrder.order_time }</span>
                                                    </td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    		<c:when test="${shoppingOrder.order_state=='0'}">
                                                    			待付款
                                                    		</c:when>
                                                    		<c:when test="${shoppingOrder.order_state=='1'}">
                                                    			待发货
                                                    		</c:when>
                                                    		<c:when test="${shoppingOrder.order_state=='2'}">
                                                    			待收货
                                                    		</c:when>
                                                    		<c:when test="${shoppingOrder.order_state=='3'}">
                                                    			待评价
                                                    		</c:when>
                                                    		<c:when test="${shoppingOrder.order_state=='4'}">
                                                    			待退款
                                                    		</c:when>
                                                    		<c:when test="${shoppingOrder.order_state=='5'}">
                                                    			已退款
                                                    		</c:when>
                                                    		<c:when test="${shoppingOrder.order_state=='Y'}">
                                                    			已完成
                                                    		</c:when>
                                                    	</c:choose>
                                                    </span>
                                                    </td>
                                                    <td class="p-total">${shoppingOrder.order_money}
                                                    	<a href="/ShoppingMall/user/deleteOrderById.do?order_id=${lookOrderLine.order_id}">
                                                    		<i class="fa fa-trash"></i>
                                                    	</a>
                                                    </td>
                                                    <td>
                                                    	<form action="/ShoppingMall/user/lookOrderLine.do" method="get">
                                                    		<input name="order_id" value="${shoppingOrder.order_id}" hidden="hidden">
