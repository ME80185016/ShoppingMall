                            ...
                            <div class="col-xs-12">
                                    <div class="cart-table table-responsive">
                                        <table>
                                            ...
                                            <tbody class="pt-30">
                                               <c:forEach items="${requestScope.shoppingCars}" var="shoppingCar">
                                                <tr>
                                                    <td class="p-name">
                                                        ${shoppingCar.store_name}
                                                    </td>
                                                    <td class="p-amount"><span class="amount">${shoppingCar.order_time }</span></td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    		<c:when test="${shoppingCar.order_state=='0'}">
                                                    			待付款
                                                    		</c:when>
                                                    	</c:choose>
                                                    </span>
                                                    </td>
                                                    <td class="p-total">${shoppingCar.order_money} <a href="/ShoppingMall/user/deleteOrderById.do?order_id=${shoppingCar.order_id}"><i class="fa fa-trash"></i></a></td>
                                                    <td>
                                                    	<form action="/ShoppingMall/user/lookOrderLine.do" method="post">
                                                    		<input name="order_id" value="${shoppingCar.order_id}" hidden="hidden">
