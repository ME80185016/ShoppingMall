                            ...
                            <div class="col-xs-12">
                                    <div class="cart-table table-responsive">
                                        <table>
                                            ...
                                            <tbody class="pt-30">
                                               <c:forEach items="${requestScope.waitDeliverGoods}" var="waitDeliverGood">
                                                <tr>
                                                    <td class="p-name">
                                                        ${waitDeliverGood.store_name}
                                                    </td>
                                                    <td class="p-amount"><span class="amount">${waitDeliverGood.order_time }</span></td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    		<c:when test="${waitDeliverGood.order_state=='1'}">
                                                    			待发货
                                                    		</c:when>
                                                    	</c:choose>
                                                    </span>
                                                    </td>
                                                    <td class="p-total">${waitDeliverGood.order_money} <a href="/ShoppingMall/user/deleteOrderById.do?order_id=${waitDeliverGood.order_id}"><i class="fa fa-trash"></i></a></td>
                                                    <td>
                                                    	<form action="/ShoppingMall/user/lookOrderLine.do" method="post">
                                                    		<input name="order_id" value="${waitDeliverGood.order_id}" hidden="hidden">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="footer-widget">
                                        <h5>公司</h5>
                                        <ul>
                                            <li><a href="index.jsp"><i class="fa fa-circle"></i>首页</a></li>
