<%@page import="com.hds.entity.ShoppingOrderline"%>
...
<html class="no-js" lang="en">
    <head>
        ...
        function funAssess() {
			var content=document.getElementsByName("assess_content");
			var assess=content[0].value;
			if(assess==null||assess==""){
				alert("请填写评价");
			}else{
				document.getElementById("assessForm").action="/ShoppingMall/user/userAssessGood.do";
				document.getElementById("assessForm").method="post";
                                        ...
                                        <ul>
                                            <li><a href="#">我的账号<i class="fa fa-angle-down"></i></a>
                                                <ul class="submenu-mainmenu">
                                                    ...
                                                    <li><a href="/ShoppingMall/user/userLookCollectGood.do"><i class="fa fa-circle"></i>收藏商品</a></li>
                                                    <li><a href="/ShoppingMall/user/userLookShoppingCar.do"><i class="fa fa-circle"></i>购物车</a></li>
                                                    <li><a href="/ShoppingMall/page/user/lookUserInfo.jsp"><i class="fa fa-circle"></i>查看信息</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <nav>
                            <div class="mainmenu">
                                <ul>
									...
									<li><a href="/ShoppingMall/page/user/userPage.jsp">我的首页</a></li>
									<li><a href="/ShoppingMall/user/userLookCollectGood.do">收藏商品</a></li>
									<li><a href="/ShoppingMall/user/userLookCollectStore.do">收藏店铺</a></li>
                                    <li><a href="/ShoppingMall/page/user/lookUserInfo.jsp">我的信息</a></li>
                                </ul>
                            </div>
                        </nav>                  
                    </div>    
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="mobile-menu">
                                        <nav id="dropdown">
                                            <ul>
                                                <li><a href="/ShoppingMall/index.html">商城首页</a></li>
												<li><a href="/ShoppingMall/page/user/userPage.jsp">我的首页</a></li>
												<li><a href="/ShoppingMall/user/userLookCollectGood.do">收藏商品</a></li>
												<li><a href="/ShoppingMall/user/userLookCollectStore.do">收藏店铺</a></li>
                                    			<li><a href="/ShoppingMall/page/user/lookUserInfo.jsp">我的信息</a></li>
                            ...
                            <div class="col-xs-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">shopping car</h2>
                                    </div>
                                    <div class="breadcrumbs">
                                        <ul>
                                            <li class="text-capitalize"><a href="/ShoppingMall/index.html">商城首页</a> ></li>
                                            <li class="text-capitalize"><a href="/ShoppingMall/user/userLookGood.do">浏览商品</a> ></li>
                                            <li class="text-capitalize"><a href="/ShoppingMall/user/userLookStore.do">浏览店铺</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="cart-tab-menu section-tab-menu pb-50 text-center">
                                    <ul>
                                        <li class="text-uppercase"><a href="/ShoppingMall/user/userLookShoppingCar.do">购物车</a></li>
                                        <li class="text-uppercase"><a href="/ShoppingMall/user/userLookWaitDeliver.do">待发货</a></li>
                                        <li class="text-uppercase"><a href="/ShoppingMall/user/userLookWaitReceipt.do">待收货</a></li>
                                        <li class="text-uppercase"><a href="/ShoppingMall/user/userLookWaitAssess.do">待评价</a></li>
                                        <li class="text-uppercase"><a href="/ShoppingMall/user/userLookWaitBackMoney.do">待退款</a></li>
                                        <li class="text-uppercase"><a href="/ShoppingMall/user/userLookBackMoney.do">已退款</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="p-amount">商品数量</th>
                                                    <th class="p-quantity">订单状态</th>
                                                    <th class="p-quantity">商品价格</th>
                                                    <th class="p-total">地址</th>
                                                </tr>
                                            </thead>
                                            <tbody class="pt-30">
                                                <tr>
                                                    <td class="p-name">
                                                       <img alt="商品图片" src="/ShoppingMall/${lookOrderLine.image_route}">
                                                       <p>${lookOrderLine.good_name}</p> 
                                                    </td>
                                                    <td class="p-amount"><span class="amount">${lookOrderLine.good_num}</span></td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    		<c:when test="${lookOrderLine.order_state=='0'}">
                                                    			待付款
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='1'}">
                                                    			待发货
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='2'}">
                                                    			待收货
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='3'}">
                                                    			待评价
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='4'}">
                                                    			待退款
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='5'}">
                                                    			已退款
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='Y'}">
                                                    			已完成
                                                    		</c:when>
                                                    	</c:choose>
                                                    </span>
                                                    </td>
                                                    <td class="p-total">${lookOrderLine.good_price} 
                                                    	<a href="/ShoppingMall/user/deleteOrderById.do?order_id=${lookOrderLine.order_id}">
                                                    		<i class="fa fa-trash"></i>
                                                    	</a>
                                                    </td>
                                                    <td>${lookOrderLine.address_name}</td>
                                                    <tr>
                                                    	<td>
                                                    		<c:choose>
                                                    		 <c:when test="${lookOrderLine.order_state=='0'}">
                                                    			<a href="/ShoppingMall/page/user/accoutOrder.jsp">结算此订单</a>
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='1'}">
                                                    			<form action="/ShoppingMall/user/backOrder.do" method="post">
                                                    				<input name="order_id" value="${sessionScope.lookOrderLine.order_id}" hidden="hidden">
                                                    				<input type="submit" value="发起退款申请">
                                                    			</form>
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='2'}">
                                                    			<p>
                                                    			...
                                                    			<p>
                                                    				<form action="/ShoppingMall/user/userReceiptGood.do" method="post">
                                                    					<input name="order_id" value="${sessionScope.lookOrderLine.order_id}" hidden="hidden">
                                                    		...
                                                    		<c:when test="${lookOrderLine.order_state=='3'}">
                                                    			<form action="" method="" id="assessForm">
                                                    				<input name="order_id" value="${sessionScope.lookOrderLine.order_id}" hidden="hidden">
                                                    				<input name="good_id" value="${sessionScope.lookOrderLine.good_id}" hidden="hidden">
                                                    				<textarea rows="2" cols="500" name="assess_content"></textarea>
                                                    				<input type="submit" value="评价" onclick="funAssess()">
                                                    			</form>
                                                    		</c:when>
                                                    		<c:when test="${lookOrderLine.order_state=='4'}">
                                                    			<form action="/ShoppingMall/user/userNotBackMoney.do" method="post">
                                                    				<input name="order_id" value="${sessionScope.lookOrderLine.order_id}" hidden="hidden">
                                                    				<input type="submit" value="取消退款申请">
                                                    			</form>
                                                    		</c:when>
                                                    	</c:choose>
                                                    	</td>
