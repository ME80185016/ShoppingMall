                            ...
                            <div class="col-xs-12">
                                    <div class="cart-table table-responsive">
                                        <table>
                                            ...
                                            <tbody class="pt-30">
                                               <c:forEach items="${requestScope.waitAssessGoods}" var="waitAssessGood">
                                                <tr>
                                                    <td class="p-name">
                                                        ${waitAssessGood.store_name}
                                                    </td>
                                                    <td class="p-amount"><span class="amount">${waitAssessGood.order_time }</span></td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    		<c:when test="${waitAssessGood.order_state=='3'}">
                                                    			待评价
                                                    		</c:when>
                                                    	</c:choose>
                                                    </span>
                                                    </td>
                                                    <td class="p-total">${waitAssessGood.order_money} <a href="/ShoppingMall/user/deleteOrderById.do?order_id=${waitAssessGood.order_id}"><i class="fa fa-trash"></i></a></td>
                                                    <td>
                                                    	<form action="/ShoppingMall/user/lookOrderLine.do" method="post">
                                                    		<input name="order_id" value="${waitAssessGood.order_id}" hidden="hidden">
