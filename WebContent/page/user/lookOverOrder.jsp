                            ...
                            <div class="col-xs-12">
                                    <div class="cart-table table-responsive">
                                        <table>
                                            ...
                                            <tbody class="pt-30">
                                               <c:forEach items="${requestScope.overOrders}" var="overOrder">
                                                <tr>
                                                    <td class="p-name">
                                                        ${overOrder.store_name}
                                                    </td>
                                                    <td class="p-amount"><span class="amount">${overOrder.order_time }</span></td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    		<c:when test="${overOrder.order_state=='Y'}">
                                                    			已完成
                                                    		</c:when>
                                                    	</c:choose>
                                                    </span>
                                                    </td>
                                                    <td class="p-total">${overOrder.order_money} 
                                                    <a href="/ShoppingMall/user/deleteOrderById.do?order_id=${overOrder.order_id}">
                                                    <i class="fa fa-trash"></i>
                                                    </a>
                                                    </td>
                                                    <td>
                                                    	<form action="/ShoppingMall/user/lookOrderLine.do" method="post">
                                                    		<input name="order_id" value="${overOrder.order_id}" hidden="hidden">
