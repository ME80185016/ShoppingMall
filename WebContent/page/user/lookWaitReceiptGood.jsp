                            ...
                            <div class="col-xs-12">
                                    <div class="cart-table table-responsive">
                                        <table>
                                            ...
                                            <tbody class="pt-30">
                                               <c:forEach items="${requestScope.waitReceiptGoods}" var="waitReceiptGood">
                                                <tr>
                                                    <td class="p-name">
                                                        ${waitReceiptGood.store_name}
                                                    </td>
                                                    <td class="p-amount"><span class="amount">${waitReceiptGood.order_time }</span></td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    		<c:when test="${waitReceiptGood.order_state=='2'}">
                                                    			待收货
                                                    		</c:when>
                                                    	</c:choose>
                                                    </span>
                                                    </td>
                                                    <td class="p-total">${waitReceiptGood.order_money} <a href="/ShoppingMall/user/deleteOrderById.do?order_id=${waitReceiptGood.order_id}"><i class="fa fa-trash"></i></a></td>
                                                    <td>
                                                    	<form action="/ShoppingMall/user/lookOrderLine.do" method="post">
                                                    		<input name="order_id" value="${waitReceiptGood.order_id}" hidden="hidden">
