                            ...
                            <div class="col-xs-12">
                                <div class="banner-text text-center">
                                    <div class="banner-title">
                                        <h2 class="text-uppercase">ORDERLINE</h2>
                                    </div>
                                        ...
                                        <table>
                                            ...
                                            <tbody class="pt-30">
                                                <tr>
                                                    ...
                                                    <td class="p-amount">
                                                    <span class="amount">${lookOrderLine.good_num}</span>
                                                    </td>
                                                    <td class="p-quantity">
                                                    <span>
                                                    	<c:choose>
                                                    ...
                                                    <tr>
                                                    	<td>
                                                    		...
                                                    		<c:when test="${lookOrderLine.order_state=='1'}">
                                                    			<form action="/ShoppingMall/store/storeAcceptOrder.do" method="post">
                                                    		...
                                                    		<c:when test="${lookOrderLine.order_state=='4'}">
                                                    			<form action="/ShoppingMall/store/storeBackOrder.do" method="post">
                                                    				<input name="order_id" value="${sessionScope.lookOrderLine.order_id}" hidden="hidden">
